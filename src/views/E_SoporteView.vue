    ...
    <div class="container">
      ...
      <div class="content">
        <div class="logo-container">
          <img src="@/assets/logo-soporte.png" alt="Logo ENSEA" class="logo-plataforma"/>
        </div>
       <br>
       <br>
       <div class="logo-container-producto">
          <img src="@/assets/soporte-email.png" alt="Logo ENSEA" class="logo-plataforma-producto" />
        </div>

        <div class="logo-container-producto">
          <img src="@/assets/soporte-whatsapp.png" alt="Logo ENSEA" class="logo-plataforma-producto" />
        </div>

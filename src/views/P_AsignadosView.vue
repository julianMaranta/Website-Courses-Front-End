    ...
    <div class="container">
      ...
      <div class="content">
        <div class="logo-container">
          <img src="@/assets/logo-asignados.png" alt="Logo ENSEA" class="logo-plataforma"/>
        </div>
        <br>   
        <br>
        ...
        <div class="course-box" v-for="curso in cursosComprados" :key="curso.id">
          <div class="course-info">
            <h2>{{ curso.nombre }}</h2>
            <p>Accede al curso, revisa el avance y las clases.</p>
          </div>
        ...
        <div class="course-box" v-for="especializacion in especializacionesCompradas" :key="especializacion.id">
          <div class="course-info">
            ...
            <p>Accede a la especializacion, revisa el avance y las clases.</p>
          </div>
        ...
        <div class="course-box" v-for="tutoria in tutoriasCompradas" :key="tutoria.id">
          <div class="course-info">
            ...
            <p>Accede a la tutoría, revisa el avance y las clases.</p>
          </div>

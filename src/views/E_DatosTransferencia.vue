    ...
    <div class="container">
      ...
      <div class="content">
        <div class="logo-container">
          <img src="@/assets/logo-transferencia.png" alt="Logo ENSEA" class="logo-plataforma"/>
        </div>
       <br>
       <br>
       <div class="logo-container-producto">
          <img src="@/assets/nombre-transferencia.png" alt="Logo ENSEA" class="logo-plataforma-producto" />
        </div>

        <div class="logo-container-producto">
          <img src="@/assets/alias-transferencia.png" alt="Logo ENSEA" class="logo-plataforma-producto" />
        </div>
        <div class="logo-container-producto">
          <img src="@/assets/cbu-transferencia.png" alt="Logo ENSEA" class="logo-plataforma-producto" />
        </div>
        <div class="logo-container-producto">
          <img src="@/assets/banco-transferencia.png" alt="Logo ENSEA" class="logo-plataforma-producto" />
        </div>
...
.logo-container-producto {
  ...
  .comunidad-button {
    background-image: url('@/assets/background-boton-caja home.png');
    background-size: cover;
    background-position: center;
    color: white;
    height: 60px;

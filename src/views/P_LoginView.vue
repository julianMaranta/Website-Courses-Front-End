<template>
   <div class="container">
    <div class="content">
    <section id="login-profesor" class="main-section">
      <div class="login">
        <h2 class="title-informacion">PROFESOR - Iniciar Sesión</h2>
  ...
  const loginUser = async () => {
    try {
      const response = await client.models.Usuario.list({
        filter: { correo: { eq: loginEmail.value }, rol: { eq: 'Profesor' } }
      });

  ...
  <div class="container">
    ...
    <div class="content">
      <div class="logo-container">
        <img src="@/assets/logo-inicio-profesores.png" alt="Logo ENSEA" class="logo-plataforma"/>
      </div>
      <br>   
      <br>
      ...
      <div class="course-box">
        <div class="course-info">
          <h2>MENSAJES</h2>
          <p>Accede a los mensajes para responder de todos los estudiantes.</p>
        </div>
      ...
      <div class="course-box">
        <div class="course-info">
          <h2>EVALUACIONES</h2>
          <p>Califica las evaluaciones!</p>
        </div>
        <button @click="goToGmailActivity" id="gmail-button">
          <img src="@/assets/Boton Gmail.png" alt="Botón Vimeo" />
        </button>
      </div>
      <div class="course-box">
        <div class="course-info">
          ...
          <p>Habilita la descarga de certificados para los estudiantes.</p>
        </div>
        <button @click="createCert" class="comunidad-button"></button>
      </div>
      <div class="course-box">
        <div class="course-info">
          <h2>COMUNIDAD SEA</h2>
...
import type { Schema } from '../../amplify/data/resource'; // Ajusta la ruta según tu estructura de proyecto
...
const goToCourse = (id: string) => {
  router.push(`/listado-clases-profesor/${id}`);
};

const goToEspecializacion = (id: string) => {
  router.push(`/listado-especializaciones-profesor/${id}`);
};

const goToTutoria = (id: string) => {
  router.push(`/listado-tutorias-profesor/${id}`);
};
...
const goToGmailActivity = () => {
  window.location.href = 'https://mail.google.com/mail/u/0/#inbox';
};

const goToComunidad = () => {
    router.push('/comunidad-sea-profesor');
  };

const createCert = () => {
    router.push('/crear-certificado');
  };
